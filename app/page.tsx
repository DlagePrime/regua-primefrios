...
export default function Home() {
  ...
  async function carregar(silencioso = false) {
    ...
    let query = supabase.schema('omie_core').from('clientes').select('id, razao_social, nome_fantasia, cnpj_cpf, whatsapp, contato, nome_vendedor_padrao_snapshot, cliente_desbloqueado_regua')
