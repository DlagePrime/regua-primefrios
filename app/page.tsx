...
function titulos(payload: unknown): TituloVencido[] {
  ...
  return data.titulos.map((t, i) => ({ id: `${String(t.doc || 'sem-doc')}-${i}`, doc: String(t.doc || ''), status: String(t.status || ''), parcela: String(t.parcela || ''), vencimento: String(t.vencimento || ''), valor_fatura: String(t.valor_fatura || '') }))
}
